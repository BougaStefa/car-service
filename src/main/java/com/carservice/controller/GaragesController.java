    ...
    private void setupActionsColumn() {
        actionsColumn.setCellFactory(param -> new TableCell<>() {
...

            {
                ...
                editButton.setOnAction(event -> handleEditGarage(getTableView().getItems().get(getIndex())));
                deleteButton.setOnAction(event -> handleDeleteGarage(getTableView().getItems().get(getIndex())));
            }
